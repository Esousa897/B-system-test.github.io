    ...
    <div className="relative bg-accentLight py-3 border-t border-b border-gray-200">
      ...
      >
        {categories.map((category, index) => (
          <button
            key={index}
            className={`whitespace-nowrap text-sm font-medium px-1 py-1 border-b-2 transition-colors duration-200 ${
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        <div 
          className={`absolute inset-0 bg-black bg-opacity-0 transition-all duration-300 flex flex-col justify-between p-4 ${
          ...
          <div className="flex justify-between">
            ...
            <button 
              ...
              className={`p-2 rounded-full ${
                product.isFavorite ? 'bg-accentBeige text-white' : 'bg-white text-black'
              }`}
            >
              ...
              {product.colors.map((color) => (
                <button
                  ...
                  className={`w-6 h-6 rounded-full border-2 ${
                    selectedColor === color ? 'border-accentBeige' : 'border-transparent'
                  }`}
